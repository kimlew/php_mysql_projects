...
<form enctype="multipart/form-data" method="POST" action="kimart_internal_search_art.php">
 <div id="main">
  ...
  <div class = "two_columns">
    ...
    <div class = "column1">
      <p><input type="checkbox" name="deleted_works" value="deleted_works_checked" 
        <?php if (isset($_POST['deleted_works']) == "deleted_works_checked") echo "checked='checked'" ?>>Deleted Works Only</p>
      ...
      <?php
        if (isset($_POST['search'])) {          
          if ((isset($_POST['deleted_works'])) && (isset($_POST['search_term']))) {       
          ...
          else if (isset($_POST['deleted_works']) && (!isset($_POST['search_term']))) {
            $command = "SELECT kimart_id, kimart_title, kimart_year FROM kimart_tb 
              WHERE date_discont > 0
              ORDER BY kimart_title ASC;";
          }
          ...
          if ($result->num_rows <= 0) {
            ...
            while ($row = mysqli_fetch_assoc($result)) {
              // Pass kimart_id in URL with link to kimart_internal_view_details.php.
              $kimart_id = $row['kimart_id'];
              echo "<br><a href=\"kimart_internal_view_details.php?kimart_id=" . $kimart_id . "\">";
    ...
    <div class = "column2">      
      <p class = "links">
        <a href="kimart_internal_add_work.php?kimart_id&kimart_title"> Add New Work </a><br>
      </p>
    </div>
